  ...
  return (
    <SectionContainer id="feature-grid" background="neutral">
        ...
        <div className="grid w-full max-w-screen-2xl mx-auto gap-6 md:grid-cols-2 lg:grid-cols-4 auto-rows-fr">
          {/* Apple Intelligence */}
          <div className="h-full flex flex-col items-center justify-center rounded-3xl bg-white p-8 text-center shadow-sm dark:bg-neutral-800">
          ...
          <div className="h-full flex flex-col items-center justify-center rounded-3xl bg-white p-8 text-center shadow-sm dark:bg-neutral-800">
            <div className="flex flex-col items-center">
              <p className="text-sm font-medium text-neutral-500 mb-2">Up to</p>
              <p className="text-[42px] font-bold leading-none text-neutral-900 dark:text-white">400%</p>
          ...
          <div className="h-full flex flex-col items-center justify-center rounded-3xl bg-white p-8 text-center shadow-sm dark:bg-neutral-800">
            ...
            <div className="text-[15px] font-medium text-neutral-600 dark:text-neutral-300 flex flex-col items-center leading-snug">
              <span className="text-neutral-500 mb-2">Remote emergency services</span>
              <div className="mb-2">
              ...
              <span className="font-semibold text-xl text-neutral-900 dark:text-white">Disaster Recovery and Resolution</span>
            </div>
          </div>
