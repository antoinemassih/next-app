...
export default function FeatureGrid() {
  return (
    <SectionContainer id="feature-grid" background="neutral">
        ...
        {/* Feature Grid */}
        <div className="grid w-full max-w-screen-2xl mx-auto gap-6 md:grid-cols-2 lg:grid-cols-4">
          {/* Apple Intelligence */}
          <div className="flex flex-col items-center rounded-3xl bg-white p-8 text-center shadow-sm dark:bg-neutral-800">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="mt-1 text-[40px] md:text-[40px] font-medium leading-tight bg-gradient-to-r from-fuchsia-500 via-rose-500 to-amber-400 bg-clip-text text-transparent">
                Rudy Intelligence
              </p>
              <p className="mt-2 text-[14px] font-medium text-neutral-600 dark:text-neutral-300">
                for the toughest  <br/>strategic & creative marketing
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center rounded-3xl bg-white p-8 text-center shadow-sm dark:bg-neutral-800">
            <div className="mb-4 flex flex-col items-center">
              <div className="mb-3 flex h-8 w-8 items-center justify-center rounded-full bg-green-500">
          ...
          <div className="flex flex-col items-center rounded-3xl bg-white p-8 text-center shadow-sm dark:bg-neutral-800">
            ...
            <p className="text-[15px] font-medium text-neutral-600 dark:text-neutral-300">
              <span className="block">Emergency services</span>
              <span className="block font-semibold text-xl text-neutral-900 dark:text-white">Remote Disaster Recovery</span>
              <span className="block">and resolution</span>
            </p>
          </div>
          ...
          <div className="flex flex-col items-center rounded-3xl bg-white p-8 text-center shadow-sm dark:bg-neutral-800">
            <div className="mb-4">
              <p className="text-l font-medium text-neutral-500">
                <span className="block">Tough by nature</span>
                <div className="mt-4">
                <svg
                ...
                <span className="block pt-4">with Bullshit Shield</span>
              </p>
          ...
          <div className="flex flex-col items-center rounded-3xl bg-white p-8 text-center shadow-sm dark:bg-neutral-800">
            ...
            <p className="text-[15px] font-medium text-neutral-600 dark:text-neutral-300">
              Seamless Integrations<br/><p className="text-[20px] font-medium text-grey-900 dark:text-neutral-300">with anyone</p>
            </p>
          </div>
        </div>
    </SectionContainer>
